...
$(document).ready(function () {
    ...
    if (typeof noUiSlider === 'object') {
        ...
        priceSlider.noUiSlider.on('update', function (values, handle) {
            ...
            var a1 = values[0].substring(0, values[0].length - 3);
            var a2 = values[1].substring(0, values[1].length - 3);
            $("#amount1").text(formatCash(a1) + " VND - " + formatCash(a2) + " VND");
            $("#amount2").val(parseInt(values[0]));
            $("#amount3").val(parseInt(values[1]));
        });
    }
