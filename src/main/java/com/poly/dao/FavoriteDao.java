...
//	List<Favorite> findFavoriteByAccount_Username(String username);
...
//	List<Favorite> checkFavorite(@Param("product_id") Integer product_id ,@Param("username") String username);
