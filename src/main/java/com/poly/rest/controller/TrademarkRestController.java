...
public class TrademarkRestController {
	...
	public List<Trademark> findAllByNameLike(@PathVariable("keyword") String keyword) {
		return trademarkService.findAllByNameLike("%" + keyword + "%");
	}
	...
	public void delete(@PathVariable("trademark_id") Integer trademark_id) {
